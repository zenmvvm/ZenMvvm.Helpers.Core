# ![Logo](art/ZenMvvm.Helpers.Core-64x64.png) ZenMvvm.Helpers.Core
Description here

[![Coverage](https://raw.githubusercontent.com/zenmvvm/ZenMvvm.Helpers.Core/develop/coverage/badge_linecoverage.svg)](https://htmlpreview.github.io/?https://raw.githubusercontent.com/zenmvvm/ZenMvvm.Helpers.Core/develop/coverage/index.html) [![NuGet](https://buildstats.info/nuget/ZenMvvm.Helpers.Core?includePreReleases=false)](https://www.nuget.org/packages/ZenMvvm.Helpers.Core/)
...
curl --location --remote-name https://github.com/z33bs/ZenMvvm.Helpers.Core/archive/master.zip
unzip master.zip
git archive https://github.com/z33bs/ZenMvvm.Helpers.Core
wget https://github.com/z33bs/ZenMvvm.Helpers.Core/archive/master.zip
...
git clone https://github.com/z33bs/ZenMvvm.Helpers.Core
rm -rf .git
...
```bash
git clone https://github.com/z33bs/ZenMvvm.Helpers.Core NewName
cd NewName
rm -rf .git
